...
public class PathUtil {
    ...
    private static final String LIBRARIES_SUBPATH = "Libraries";
    ...
    private static final String DEFAULT_NUGET_CACHE_DIR = "/nugetcache";
    ...
    public static File getLibrariesDir() throws IOException {
        return createAndReturn(new File(projectDir, LIBRARIES_SUBPATH));
    }
    ...
    public static File getDefaultNugetCacheDir() {
        return new File(DEFAULT_NUGET_CACHE_DIR);
    }
